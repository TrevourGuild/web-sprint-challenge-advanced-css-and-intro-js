...
function addArtist(array){
    array.push({ 
      ...
      genre: 'Web Design', 
      nationality: 'White',
      bio: 'A web designer video game player who enjoyes watching youtube boxing events and playing baseball. This guy loves to code and is all about eating good food'
    });
...
function lotsOfArt(array){
  ...
  for(let i = 0; i < array.length; i++){
    if(array[i].paintings >= 100){
      artistsPaint.push(array[i].name);
    }
  }
  return artistsPaint;
}
